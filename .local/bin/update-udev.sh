#!/bin/bash
touch /etc/udev/etc/50-powersave-net-bak.rules
touch /etc/udev/etc/50-wake-on-device.rules
touch /etc/udev/etc/81-wifi-powersave.rules

cat<<EOF>>/etc/udev/etc/50-powersave-net-bak.rules
...
cat<<EOF>>/etc/udev/etc/50-wake-on-device.rules
...
cat<<EOF>>/etc/udev/etc/81-wifi-powersave.rules
